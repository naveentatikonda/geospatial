...
public class QueryTestHelper extends GeospatialRestTestCase {
    ...
    public SearchResponse searchUsingIntersectsRelation(String indexName, String fieldName, Geometry geometry) throws IOException {
        String searchEntity = buildSearchBodyAsString(builder -> {
            ...
            builder.field(SHAPE_RELATION, ShapeRelation.INTERSECTS.getRelationName());
