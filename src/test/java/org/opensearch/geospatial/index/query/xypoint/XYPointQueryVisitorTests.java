...
import static org.opensearch.geospatial.index.common.xyshape.ShapeObjectBuilder.*;
...
public class XYPointQueryVisitorTests extends OpenSearchTestCase {
    ...
    public void setUp() throws Exception {
        ...
        queryVisitor = new XYPointQueryVisitor(context, fieldType, fieldName, relation);
    }
    ...
    public void testQueryingLinearRing() {
        ...
        assertEquals(
            String.format("Field [%s] found an unsupported shape [%s]", fieldName, ShapeType.LINEARRING.name()),
    ...
    public void testQueryingMultiLine() {
        ...
        assertEquals(
            String.format("Field [%s] found an unsupported shape [%s]", fieldName, ShapeType.MULTILINESTRING.name()),
            exception.getMessage()
        );
    }
    ...
    public void testQueryingMultiPoint() {
        ...
        assertEquals(
            String.format("Field [%s] found an unsupported shape [%s]", fieldName, ShapeType.MULTIPOINT.name()),
            exception.getMessage()
        );
    }
    ...
    public void testQueryingPoint() {
        ...
        assertEquals(
            String.format("Field [%s] found an unsupported shape [%s]", fieldName, ShapeType.POINT.name()),
            exception.getMessage()
        );
    }
    ...
    public void testQueryingLine() {
        ...
        assertEquals(
            String.format("Field [%s] found an unsupported shape [%s]", fieldName, ShapeType.LINESTRING.name()),
            exception.getMessage()
        );
    }
    ...
    public void testQueryingCircle() {
        ...
        assertEquals(
            String.format("Field [%s] found an unsupported shape [%s]", fieldName, ShapeType.CIRCLE.name()),
            exception.getMessage()
        );
    }
    ...
    public void testQueryingUnsupportedGeometryCollection() {
        ...
        assertTrue(
            ...
            exception.getMessage().contains(String.format("Field [%s] found an unsupported shape", fieldName))
        );
    }
}
