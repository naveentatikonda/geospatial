...
public class XYPointQueryIT extends AbstractXYShapeQueryTestCase {
    ...
    public void testNullShape() throws Exception {
        queryTestUsingNullShape(indexName, xyPointFieldName, XYPointFieldMapper.CONTENT_TYPE);
    }
    ...
    public void testIndexPointsFilterRectangleWithIntersectsRelation() throws Exception {
        ...
        final String firstDocumentID = indexDocumentUsingWKT(indexName, xyPointFieldName, "POINT(-30 -30)");
        indexDocumentUsingWKT(indexName, xyPointFieldName, "POINT(-45 -50)");

        Rectangle rectangle = new Rectangle(-45, 45, 45, -45);
        final SearchResponse searchResponse = searchUsingShapeRelation(indexName, xyPointFieldName, rectangle, ShapeRelation.INTERSECTS);
    ...
    public void testIndexPointsIndexedRectangleMatches() throws Exception {
        ...
        indexDocumentUsingWKT(indexName, xyPointFieldName, "POINT(-30 -30)");
        final String secondDocumentID = indexDocumentUsingWKT(indexName, xyPointFieldName, "POINT(-45 -50)");
    ...
    public void testIndexPointsCircle() throws Exception {
        ...
        indexDocumentUsingWKT(indexName, xyPointFieldName, "POINT(-131 -30)");
        final String secondDocumentID = indexDocumentUsingWKT(indexName, xyPointFieldName, "POINT(-45 -50)");

        Circle circle = new Circle(-30, -30, 100);

        final SearchResponse searchResponse = searchUsingShapeRelation(indexName, xyPointFieldName, circle, ShapeRelation.INTERSECTS);
        assertSearchResponse(searchResponse);
        assertHitCount(searchResponse, 1);
        MatcherAssert.assertThat(searchResponse.getHits().getAt(0).getId(), equalTo(secondDocumentID));
    ...
    public void testIndexPointsPolygon() throws Exception {
        ...
        final SearchResponse searchResponse = searchUsingShapeRelation(indexName, xyPointFieldName, polygon, ShapeRelation.INTERSECTS);
        assertSearchResponse(searchResponse);
        assertHitCount(searchResponse, 1);
        MatcherAssert.assertThat(searchResponse.getHits().getAt(0).getId(), equalTo(firstDocumentID));
    ...
    public void testIndexPointsMultiPolygon() throws Exception {
        ...
        final String firstDocumentID = indexDocumentUsingWKT(indexName, xyPointFieldName, "POINT(-30 -30)");
        indexDocumentUsingWKT(indexName, xyPointFieldName, "POINT(-40 -40)");
        final String thirdDocumentId = indexDocumentUsingWKT(indexName, xyPointFieldName, "POINT(-50 -50)");
        ...
        final SearchResponse searchResponse = searchUsingShapeRelation(indexName, xyPointFieldName, multiPolygon, ShapeRelation.INTERSECTS);
        assertSearchResponse(searchResponse);
